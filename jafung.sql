...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2016 at 04:21 AM
...
CREATE TABLE IF NOT EXISTS `tbl_dupak` (
  ...
  `ak_diajukan` int(11) NOT NULL,
  `ak_disetujuin` int(11) NOT NULL,
...
(1, '2016-06-26', 'a', 'a', 'Draft', 0, 0, 116),
(2, '2016-06-08', 'd', 'd', 'Pengajuan', 0, 0, 116),
(3, '2016-06-24', 's', 'g', 'Proses', 0, 0, 116),
(4, '2016-06-15', 'g', 'b', 'Penetapan', 0, 0, 116),
(5, '2016-06-09', 'f', 's', 'Draft', 0, 0, 116),
(6, '2016-06-18', 'g', 'd', 'Pengajuan', 0, 0, 116),
(7, '2016-06-18', 'f', 's', 'Penilaian', 0, 0, 116),
(8, '2016-06-28', 'f', 'g', 'Draft', 0, 0, 116),
(9, '2016-06-02', 'df', 'd', 'Pengajuan', 0, 0, 116),
(10, '2016-06-17', 'f', 'c', 'Penetapan', 0, 0, 116),
(11, '2016-06-11', 'f', 'c', 'Penilaian', 0, 0, 116),
(12, '2016-06-10', 'Pendidikan', '2005', 'Draft', 300, 0, 116);
