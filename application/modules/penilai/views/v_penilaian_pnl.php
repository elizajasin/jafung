      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="<?php echo base_url(). 'index.php/penilai/penilaian'; ?>"><i class="fa fa-circle-o"></i>Penilaian</a></li>
                <li><a href="<?php echo base_url(). 'index.php/penilai/laporan'; ?>"><i class="fa fa-circle-o"></i>Laporan</a></li>
            </ul>
        </li>
      </ul>
    </section>
              ...
              <div class="col-sm-12">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                    <th>No.</th>
                    <th>Unsur Butir Kegiatan</th>
                    <th>Nama Kegiatan</th>
                    <th>Jumlah angka Kredit yang diajukan untuk Kegiatan</th>
                    <th>Jumlah dan Satuan Kegiatan</th>
                    <th>File Bukti Fisik terkait Kegiatan</th>
                    <th>Catatan dari Tim Penilai</th>
                    <th>Aksi</th>
                  </tr>
