      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="<?php echo base_url(). 'index.php/penilai/daftarpak'; ?>"><i class="fa fa-circle-o"></i>Daftar PAK</a></li>
              ...
              <div class="col-sm-12">
                ...
                <tbody>
                  ...
                  <?php  foreach($data as $d){
                   ?>
                  <tr>
                                     <?php $polin= $d['tgl_pengajuan']; 
                  $format1 = date('d F Y', strtotime($polin ));
                   ?>
