<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><img width=50 height=30 src="<?php echo base_url()."assets/"; ?>image/jafungmini.png"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img width=150 height=50 src="<?php echo base_url()."assets/"; ?>image/jafung.png"></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $_SESSION['nama']; ?> - <?php echo $_SESSION['level']; ?>
