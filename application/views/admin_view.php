...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-mini"><b>Ja</b>fung</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Sisfo</b>Jabatan Fungsional</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
            <a href="<?php echo base_url()."assets/"; ?>documentation/index.html"><i class="fa fa-book"></i> <span>Profile</span></a>
        </li>
        <li class="treeview">
            <a href="#"><i class="fa fa-dashboard"></i> <span>PAK</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
                <li><a href="index.html"><i class="fa fa-circle-o"></i>Daftar PAK</a></li>
                <li><a href="index2.html"><i class="fa fa-circle-o"></i>Detail PAK</a></li>
                <li><a href="index2.html"><i class="fa fa-circle-o"></i>Isi dan Edit Rincian Kredit</a></li>
                <li><a href="index2.html"><i class="fa fa-circle-o"></i>DUPAK</a></li>
            </ul>
        </li>
      </ul>
    </section>
